...
const Faq = () => {
  return (
      <div className="flex lg:flex-row flex-col items-center py-[100px] px-[40px] lg:px-[136px]">
        <div className='flex flex-col items-center lg:items-start mb-[16px]'>
          ...
          <p className="text-[18px] mb-[18px] sm:w-[75%] lg:text-left text-center">We have already curated some of the common asked questions for you</p>
