const TestimonialCard = ({ img, proImg, name, desc }) => {
	return (
	  <div className="flex gap-10">
		<div className="min-w-[400px] bg-white shadow-lg rounded-lg my-20 relative">
		  ...
		  <div className="flex">
			<img className="w-20 rotate-[4deg]" src={proImg} alt="person" />
			<div className="mt-6 ml-2">
			  <div className="font-bold text-md">{name}</div>
			  <div className="text-[#1e47ff] font-semibold text-sm">{desc}</div>
			</div>
		  </div>
		</div>
	  </div>
